...
const defaultMenu = {
  before: `
(〃∀〃)ゞ Hey, I am a WhatsApp bot that can assist you with various things, Naomi will help you as long as it is within Naomi capabilities. Hehe.
...
let handler = async (m, { conn, usedPrefix: _p }) => {
  ...
  try {
    ...
    let text = Object.keys(replace).reduce((acc, key) => acc.replace(new RegExp(`%${key}`, 'g'), replace[key]), _text);
    ...
    conn.sendMessage(m.chat, {
      ...
      contextInfo: {
        externalAdReply: {
          ...
          sourceUrl: 'https://chat.whatsapp.com/IrLceGb5cSJEej45kAkBNe',
          mediaType: 1,
    ...
    conn.reply(m.chat, '_*Maaf, menu sedang error*_', m);
    throw e;
  }
}
