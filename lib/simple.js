...
exports.makeWASocket = (connectionOptions, options = {}) => {
    ...
    sendFooterDoc = async (jid, text, footer, titledoc, urldoc, urlmedia, quoted, options = {}) => {
...
let msg = await generateWAMessageFromContent(jid, { 
    ...
    interactiveMessage: {          
      ...
      ...(await prepareWAMessageMedia({ document: { url: urldoc }, mimetype: 'image/png', fileName: titledoc, jpegThumbnail: await conn.resize(urlmedia, 400, 400), fileLength: 0 }, { upload: conn.waUploadToServer }))
...
conn.sendMsgPoll = async (jid, name = '', optiPoll, options) => {
...
`.trim()
    ...
    conn.reply = (jid, text = '', quoted, options) => {
                ...
                contextInfo: setting.addReply ? global.adReply.contextInfo : null,
                mentions: conn.parseMention(text),
                ...options }, {
                    quoted,
